...
class Game {
    ...
    private assetRootURL="https://virtualblackcharlotte.com/dev/babylonjs/grier/assets/";
    ...
    constructor() {
        ...
        this.canvas = document.getElementById("renderCanvas3") as HTMLCanvasElement;
    ...
    private async createScene() {
        ...
        SceneLoader.Append(this.assetRootURL, "grier.glb", this.scene,
            (scene) => {
        ...
        hotspotArray.push(this.createPictureHotspot(new Vector3(0, 5, 0.25), this.scene, this.assetRootURL+"grier.jpg"));
        hotspotArray.push(this.createAudioHotspot(new Vector3(-1, 5, 0.25), this.scene, this.assetRootURL+"Polk_excerpt_Grier.mp3"));
        hotspotArray.push(this.createMovieHotspot(new Vector3(-2, 5, 0.25), this.scene, this.assetRootURL+"bunny.mp4"));
